...
void inline computeGTWG_Segment_AVX512FP16_16f(const _Float16 *img, const int nrows, const int ncols, const int r, const int col, _Float16 GTWG[][4], _Float16 *buf1, _Float16 *buf2, _Float16 *buf3, _Float16 *buf4);
